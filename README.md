...
# [hydazz/mosquitto](https://github.com/linuxserver/docker-mosquitto)

[![GitHub Release](https://img.shields.io/github/release/hydazz/docker-mosquitto.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/linuxserver/docker-mosquitto/releases)
[![GitHub Package Repository](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=hyde.services&message=GitHub%20Package&logo=github)](https://github.com/linuxserver/docker-mosquitto/packages)
...
![Image Size](https://img.shields.io/docker/image-size/hydaz/mosquitto.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=docker)
...
Simply pulling `ghcr.io/hydazz/mosquitto:latest` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
services:
  mosquitto:
    image: ghcr.io/hydazz/mosquitto:latest
...
docker run -d \
  ...
  --restart unless-stopped \
  ghcr.io/hydazz/mosquitto:latest
```
...
* Update the image: `docker pull ghcr.io/hydazz/mosquitto:latest`
...
```bash
git clone https://github.com/linuxserver/docker-mosquitto.git
cd docker-mosquitto
docker build \
  --no-cache \
  --pull \
  -t ghcr.io/hydazz/mosquitto:latest .
```
